<?php 
  ...
  mysqli_query($db, "START TRANSACTION");
  	...
  	$sql = "INSERT INTO video_comment (source_id, parent_id, author,text_comments,comment_start_time,comment_end_time, date) VALUES ('$videoNumber', 0,  '$author', '$comment', '$start',  '$end', '$now')";
