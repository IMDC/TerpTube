...
?>
              ...
              <div style="float:left">
                 	 <div class="video-info-container">
                 		 ...
                 		 <canvas id="linkCanvas" width="320" height="25" 
                    		 style="position: absolute; left: 0; bottom: 30%; z-index: 0; margin-left:32px;" ></canvas>
                       
                   		 <!-- traversal canvas is the playhead -->
                   		 <canvas id="traversalCanvas" width="320" height="60px" 
   					 	    style="position: absolute; left: 0; top: 0; z-index: 1; margin-left:32px"></canvas>
                  	 </div>
          ...
          <div style="clear:both"></div>
              ...
              <button name="postCommentbutton">Post a comment</button>
        ...
        <div class="comment-container" id="3" >
           ...
           <?php //This will pull non generic comments
               ...
               <div class="feedback-container">
                   ...
                   <div class="comment-content-container">
                   		<div class="comment-content">
                          		 ...
                          		 <?php //This will pull replies to comments
